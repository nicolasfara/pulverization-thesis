...
\todo{Paralre di jekins e github actions}

The CI/CD framework's pipeline is implemented using the GitHub Actions service.
...
by sharing the \emph{repository id}. In this way, the artifacts coming from different OS are uploaded to the same repository, and consequently,
the release job can release all the artifacts on the Maven Central repository consistently.
...
in~\Cref{fig:demo-2-physical-diagram}.

\todo{finire la sezione}
